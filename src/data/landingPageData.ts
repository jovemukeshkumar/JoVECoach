...
export const landingPages: Record<string, LandingPageData> = {
	"science-gen": {
		hero: {
			title: 'Science Feeling Impossible? <br class="desktop-br" /> Master It in <span class="highlight">2-Minute Videos.</span>',
			subtitle: "From confused to confident. Biology, Chemistry and Physics finally made simple. 20 years of trusted science education.",
			mobileSubtitle: "Biology, Chemistry and Physics made simple.",
		...
		concepts: {
			...
			questions: [
				...
				{ icon: conceptsSectionIcon6, text: "Why do enzymes speed up reactions?" }, // Icon6 used for Icon10 in original
				{ icon: conceptsSectionIcon8, text: "How do catalysts work in chemistry?" },
				{ icon: conceptsSectionIcon6, text: "What happens during DNA replication?" }, // Icon6 used for Icon10
				...
				{ icon: conceptsSectionIcon6, text: "Difference between mitosis and meiosis?" }, // Icon6 used for Icon10
				{ icon: conceptsSectionIcon7, text: "Why don't satellites fall to Earth?" }, // Duplicate question from original
				{ icon: conceptsSectionIcon9, text: "What causes an electric current to flow?" },
			]
		},
		steps: {
			title: `JoVE Coach is more than a study tool - <br /> <span class="highlight">it's <img src="${conceptsSectionIcon1.src}" alt="JoVE Coach" style="width: 38px; height: auto; margin-bottom: -5px;" /> that helps you finally get it.</span>`,
			subtitle: "2-minute videos. AI-backed clarity. Instant practice.",
			discoverText: "Master Science in 4 easy steps",
			items: [
				{
					id: "ask",
					icon: aILogo,
		...
		comparison: {
			...
			items: [
				...
				{ id: "tutor", name: "Tutor", logo: comparisonTableLogo4 },
				{ id: "chegg", name: "Chegg", logo: comparisonTableLogo5 },
			],
			features: [
				{
					name: "2-minute focused videos",
					values: { jove: true, khan: false, youtube: false, tutor: false, chegg: false },
				},
				{
					name: "Expert-created content",
					values: { jove: true, khan: true, youtube: false, tutor: false, chegg: true },
				},
				{
					name: "Curriculum-aligned",
					values: { jove: true, khan: true, youtube: false, tutor: false, chegg: false },
				},
				{
				...
				},
				{
					...
					values: { jove: true, khan: false, youtube: false, tutor: false, chegg: true },
				},
				{
		...
		firstCTA: {
			title: "Stuck on a concept right now?",
			subtitle: "See how JoVE Coach explains it clearly - with AI.",
			ctaText: "Start My Free Trial"
		},
		secondCTA: {
			title: 'Ready to try the <br /> “Ask → Watch → Practice” flow?',
			subtitle: "Ask a question and see how AI breaks it down in minutes.",
			ctaText: "Start My Free Trial"
		},
		pricing: {

...
// Hero Images
import HeroImage from "../../assets/highschool-biology-hero-v2.webp";
...
export const highSchoolBiologyData: LandingPageData = {
    hero: {
        ...
        heroModal: {
            title: "Master HS Biology in 2-Minute Videos <br class=\"modal-break\" />- Join 5M+ Students",
            // subtitle: "Enter your details for instant access.",
            ctaText: "Watch HS Bio Videos Free — No Signup",
            videoSrc: biologyCarouselDesktop
        },
    },
    concepts: {
        heading: 'Every <span>Biology</span> concept you need. <span>Under 2 minutes.</span>',
        subheading: "Perfect for AP Biology, Honors Biology, and high school biology classes.",
        features: [
